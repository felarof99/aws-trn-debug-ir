...
module @jit_reshape attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<16x2x2xui32> loc("args[0]")) -> (tensor<16x4xui32> {jax.result_info = ""}) {
    %0 = stablehlo.reshape %arg0 : (tensor<16x2x2xui32>) -> tensor<16x4xui32> loc(#loc25)
