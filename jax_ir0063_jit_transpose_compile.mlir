...
module @jit_transpose attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<2x4x2xui32> loc("args[0]")) -> (tensor<4x2x2xui32> {jax.result_info = ""}) {
    %0 = stablehlo.transpose %arg0, dims = [1, 0, 2] : (tensor<2x4x2xui32>) -> tensor<4x2x2xui32> loc(#loc25)
    return %0 : tensor<4x2x2xui32> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc = loc(unknown)
