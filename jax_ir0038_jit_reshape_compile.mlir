...
module @jit_reshape attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<16x3x2x2xui32> loc("args[0]")) -> (tensor<16x3x4xui32> {jax.result_info = ""}) {
    %0 = stablehlo.reshape %arg0 : (tensor<16x3x2x2xui32>) -> tensor<16x3x4xui32> loc(#loc25)
    return %0 : tensor<16x3x4xui32> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc = loc(unknown)
#loc2 = loc("/home/ubuntu/roadrunner-fork/src/felafax/trainer_engine/models/llama3/jax/model.py":451:0)
