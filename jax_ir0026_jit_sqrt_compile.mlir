#loc1 = loc("x")
module @jit_sqrt attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<bf16> loc("x")) -> (tensor<bf16> {jax.result_info = ""}) {
    %0 = stablehlo.sqrt %arg0 : tensor<bf16> loc(#loc23)
    return %0 : tensor<bf16> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc = loc(unknown)
#loc2 = loc("/home/ubuntu/roadrunner-fork/src/felafax/trainer_engine/models/llama3/jax/model.py":169:0)
...
#loc23 = loc("jit(sqrt)/jit(main)/sqrt"(#loc22))
