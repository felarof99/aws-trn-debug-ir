...
module @jit__multiply attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<16x8192x16xbf16> loc(unknown), %arg1: tensor<bf16> loc(unknown)) -> tensor<16x8192x16xbf16> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [] : (tensor<bf16>) -> tensor<16x8192x16xbf16> loc(#loc22)
    %1 = stablehlo.multiply %arg0, %0 : tensor<16x8192x16xbf16> loc(#loc22)
    return %1 : tensor<16x8192x16xbf16> loc(#loc)
  } loc(#loc)
} loc(#loc)
