...
module @jit_broadcast_in_dim attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<bf16> loc("args[0]")) -> (tensor<2048xbf16> {jax.result_info = ""}) {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [] : (tensor<bf16>) -> tensor<2048xbf16> loc(#loc25)
    return %0 : tensor<2048xbf16> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc = loc(unknown)
#loc2 = loc("/home/ubuntu/roadrunner-fork/src/felafax/trainer_engine/models/llama3/jax/model.py":254:0)
...
#loc6 = loc("/home/ubuntu/roadrunner-fork/src/felafax/trainer_engine/models/llama3/jax/model.py":521:0)
#loc7 = loc("/home/ubuntu/roadrunner-fork/src/felafax/trainer_engine/models/llama3/jax/model.py":579:0)
#loc8 = loc("/opt/aws_neuronx_venv_pytorch_2_1/lib/python3.10/site-packages/equinox/_vmap_pmap.py":204:0)
#loc9 = loc("__init__"(#loc2))
#loc10 = loc("__init__"(#loc3))
#loc11 = loc("__call__"(#loc4))
#loc12 = loc("__call__"(#loc5))
#loc13 = loc("__init__"(#loc6))
#loc14 = loc("<lambda>"(#loc7))
#loc15 = loc("_fun_wrapper"(#loc8))
