...
module @jit_squeeze attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<1x4xui32> loc("args[0]")) -> (tensor<4xui32> {jax.result_info = ""}) {
    %0 = stablehlo.reshape %arg0 : (tensor<1x4xui32>) -> tensor<4xui32> loc(#loc25)
    return %0 : tensor<4xui32> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc = loc(unknown)
#loc2 = loc("/home/ubuntu/roadrunner-fork/src/felafax/trainer_engine/models/llama3/jax/model.py":153:0)
...
#loc25 = loc("jit(squeeze)/jit(main)/squeeze"(#loc24))
