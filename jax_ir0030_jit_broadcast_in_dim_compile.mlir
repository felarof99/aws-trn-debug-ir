...
module @jit_broadcast_in_dim attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<bf16> loc("args[0]")) -> (tensor<16x512xbf16> {jax.result_info = ""}) {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [] : (tensor<bf16>) -> tensor<16x512xbf16> loc(#loc23)
    return %0 : tensor<16x512xbf16> loc(#loc)
  } loc(#loc)
} loc(#loc)
#loc = loc(unknown)
...
#loc6 = loc("/home/ubuntu/roadrunner-fork/src/felafax/trainer_engine/models/llama3/jax/model.py":317:0)
